...
void TimeManagement::init(const Search::LimitsType& limits, Color us, int ply, OptionsMap& options)
{
...
void TimeManagement::init_(const Search::LimitsType& limits, Color us, int ply, OptionsMap& options)
{
#if 0
	// nodes as timeモード
